...
<?php
    ...
    $coiusario_ses=$_SESSION['coiusuario_ses'];
    $coifuncionario_ses=$_SESSION['coifuncionario_ses'];
 ...
 if($comando=="Aceptar")
   {
     if(empty($coifuncionario_ses))
       $coifuncionario_ses = 0;

     $hoy = Date("Y-m-d");
     $q = "insert into ParaHacer values($paciente, $pieza, $pieza, $procedimiento, '$comentario', $coifuncionario_ses)"; 
     mysql_query($q);
