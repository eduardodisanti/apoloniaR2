...
echo " <a href='listarev.php?nmed=$medico&comando=Paso2'>Lista de revision</a> ";
...
echo "    <iframe src='revision.php?paciente=$paciente&usuario=$coiusuario_ses' width=100% height=510px border=0></iframe>";
echo "</td>";
echo "</tr>";
echo "</table>";
echo "</blockquote>";
