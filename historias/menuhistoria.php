...
<?php
function mostrarMenuHistoria($paciente, $medico) {
...
//	echo "<tr><td align=center><a class='menu' onclick='abrirHermes($nombre, $clave)'><img src='../img/make.png' border=0>Hermes</a></td></tr>";
	...
	echo "<tr><td align=center><a class='menu' onclick='abrirAutorizados($medico)'><img src='../img/consmed.gif' border=0 width=32>Autorizados</a></td></tr>";
