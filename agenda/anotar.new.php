...
/*    $coment=mysql_query("select * from Comentarios where Paciente=$ci");
    ...
    echo "</table>";
*/
    echo "<b>Paso 2</b>, Elegir un procedimiento <a href=\"../historias/revision.php?paciente=$ci\" target=\"_revision\">Revision</a> <a href='anotar.php?ci=$ci&comando=Paso2'>Recargar<img src='../img/reload.png' border=0 align=middle></a><br>Se atiende con $medico_actual->nombre"; 
