...
if(empty($comando))
 {
      $query="select * from Laboratorios where id='$coiFuncionario' order by descripcion";
      $qry = query($query);
  echo mysql_error();

     echo "<form action='venctrabProv.php' method=post>\n";
...
if($Laboratorio != 0)
  $limit = "and TrabSoc.Laboratorio = $Laboratorio";
else
  $limit="";
