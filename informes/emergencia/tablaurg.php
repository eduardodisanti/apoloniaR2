...
<body bgcolor="#cccccc">
<center>
<Font size=8>Orden de asignacion de urgencias</font>[Documento que cuando se imprime pierde validez]<hr>
<?
...
function laburo($mes)
{
 ...
 mysql_select_db("apolonia");
    ...
    $qry = "select sucursal, medico, Nombre, ultima from TablaUrgencias, Medicos where medico = Medicos.Numero order by Sucursal, tiempo asc, ultima asc, Numero, Nombre";
        $qry = "select sucursal, medico, Nombre, ultima from TablaUrgencias, Medicos where medico = Medicos.Numero order by Sucursal, Numero, Nombre";
