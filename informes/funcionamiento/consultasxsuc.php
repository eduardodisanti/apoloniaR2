...
if(empty($f1) || empty($f2))
 {
   ...
   echo "<form action=\"consultasxsuc.php\" method=\"post\">";
...
else
 {
   ...
   $q="select Sucursal, count(Horarios.Consultorio) as vistos from Horarios, Consultorios where Consultorio=Codigo and Fecha >= '$f1' and Fecha <= '$f2' and Paciente != 0 group by Sucursal";
