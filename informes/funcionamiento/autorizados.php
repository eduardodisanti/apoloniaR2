<?php
     ...
     $q="select Year(Fecha) as anio, Month(Fecha) as mes, count(*) as cant from Horarios where Numero >= 200 group by Year(Fecha), Month(Fecha)";

      echo "<center><h3>Evolucion de autorizados</h3>";
