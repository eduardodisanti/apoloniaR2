...
echo "<center><h4>Consulta de trabajos de laboratorio</h4></center><hr>";
if(empty($comando))
 {
  ...
  echo mysql_error();
     ...
     echo "<form action='../informes/pendalab.php' method=post>\n";
...
$query = "select Paciente, Trabajo, Fecha, Trabajos.descripcion, tiempo, Nombre, EstadosTrabajo.Descripcion from TrabSoc, Trabajos, Pacientes, EstadosTrabajo where Fecha >= '$FECHADESDE' and Fecha <='$FECHAHASTA' and Trabajo = id and Paciente = Cedula and (Entregado !=7 and Entregado != 5) and EstadosTrabajo.Codigo = TrabSoc.Entregado $limit order by Paciente, Fecha,Trabajos.descripcion";
