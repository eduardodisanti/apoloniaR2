...
$query = "select Trabajo, Trabajos.descripcion, count(*) from HistTrabSoc, Trabajos where Trabajos.id = Trabajo and Fecha >= '2006-12-01' and Fecha <='2006-12-31' and Episodio=3 and Facturable='S' group by Trabajo";

select Paciente, Trabajo, Fecha, Trabajos.descripcion, Trabajos.Costo as Importe, tiempo, Nombre, Episodio, Laboratorios.descripcion as nombreLab, Pieza from HistTrabSoc, Trabajos, Pacientes, Laboratorios where Fecha >= '$FECHADESDE' and Fecha <='$FECHAHASTA' and Trabajo = Trabajos.id and Paciente = Cedula and Trabajos.Facturable='S' and (Episodio = 5 or Episodio = 8) and Episodio != 88 $limit and HistTrabSoc.Laboratorio = Laboratorios.id group by HistTrabSoc.Paciente, HistTrabSoc.Fecha, Episodio, Trabajo order by HistTrabSoc.Laboratorio, Nombre, HistTrabSoc.Fecha, Episodio, Fecha,descripcion";
