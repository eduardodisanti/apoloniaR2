...
echo "<center><h4>Resumen de trabajos asignados a laboratorios</h4></center><hr>";
      $query="select Laboratorio, Laboratorios.descripcion as lab, count(HistTrabSoc.Paciente) as cant from HistTrabSoc, Laboratorios where Fecha='$hoy' and Laboratorios.id = HistTrabSoc.Laboratorio and Episodio = 4 group by HistTrabSoc.Laboratorio order by descripcion";
      $qry = query($query);
