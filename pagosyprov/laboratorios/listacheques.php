...
if(empty($comando))
 {
     echo "<form action='listacheques.php' method=post>\n";
...
echo "Lista de recibos pagados con cheque $factura<br>";
     
$query = "select serie, numero, fecha, Recibos.numero, laboratorio,  Laboratorios.descripcion as labdesc, importe from Recibos, Laboratorios where Cheque = '$factura' and Laboratorios.id = Recibos.laboratorio order by laboratorio, fecha, serie, numero";
