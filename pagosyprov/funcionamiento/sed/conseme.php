...
if(empty($f1) || empty($f2))
...
else
 {
   ...
   $q="select Sucursal, count(*) as vistos from Horarios, Consultorios where Consultorio=Codigo and Fecha >= '$f1' and Fecha <= '$f2' and Procedimiento = 693 group by Sucursal";
