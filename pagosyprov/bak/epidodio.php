...
?>
		...
		<TD WIDTH=34% valign="top">
			<P ALIGN=LEFT> <FONT COLOR="#ffff00">Descripcion del procedimiento Actual</FONT>
                <TEXTAREA NAME="tbComentario" ROWS=3 COLS=40 WRAP=SOFT></TEXTAREA></FONT>
<?php
      echo "<SELECT NAME=marked SIZE=10 STYLE=\"color: #ffff00; background: #666599\" onChange='cambiarProc()'>";
