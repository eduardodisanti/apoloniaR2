...
// Primero paso todos los trabajos de laboratorio.
 ...
 $qry = mysql_query("select Trabajo, Precio, Costo, TrabLab.Laboratorio, valor from TrabLab, Trabajos, TipoIva where Trabajo=Trabajos.id and TipoIva.id = Trabajos.TipoIva");
