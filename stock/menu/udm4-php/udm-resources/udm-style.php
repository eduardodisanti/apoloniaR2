...
$umr[$j++]='.udm{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['hstrip'][0])?'background-image:url('.$um['baseSRC'].$um['hstrip'][0].');':'background-image:none;background-color:'.$um['hstrip'][0].';').'float:'.$umhfl.';width:100%;}';
if($um['hstrip'][0]!='none')
{
...
$umr[$j++]='.udm ul{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menus'][7])?'background-image:url('.$um['baseSRC'].$um['menus'][7].');':'background-image:none;background-color:'.$um['menus'][7].';').$um['t'][15].'width:'.$um['menus'][5].';height:auto;'.$um['t'][5].$um['menus'][2].'px;'.$um['t'][6].$um['menus'][3].';'.$um['t'][7].$um['menus'][4].';'.$um['t'][12].'z-index:'.($um['orientation'][6]+19100).';padding:'.$um['menus'][6].'px;'.$um['menus'][8].'}';
...
$umr[$j++]='ul.udm/**/[class^="udm"] u\\l{'.$um['t'][39].$um['t'][41].'left:-10000px;}';
...
$umr[$j++]='.udm .udmS{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menus'][9])?'background-image:url('.$um['baseSRC'].$um['menus'][9].');':'background-image:none;background-color:'.$um['menus'][9].';').$um['t'][15].$um['t'][12].'z-index:'.($um['orientation'][6]+19050).';'.$um['t'][28].'left:0px;top:0px;'.$um['t'][9].$um['menus'][11].'}';
...
$umr[$j++]='.udm a,.udm a:link,.udm a.nohref{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['items'][11])?'background-image:url('.$um['baseSRC'].$um['items'][11].');':'background-image:none;background-color:'.$um['items'][11].';').$um['t'][29].'z-index:'.$um['orientation'][6].';text-align:'.$umtxl.';'.$um['t'][7].$um['items'][4].';'.$um['t'][6].$um['items'][3].';'.$um['t'][4].$um['items'][9].'px;padding-right:'.$um['items'][9].'px;'.$um['t'][1].$um['items'][10].'px !important;padding-bottom:'.$um['items'][10].'px !important;'.$um['t'][11].$um['items'][17].';color:'.$um['items'][19].';'.$um['t'][5].$um['items'][1].'px;font-style:'.$um['items'][22].';font-family:'.$um['items'][15].';font-weight:'.$um['items'][16].' !important;}';
...
$umr[$j++]='.udm li a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['items'][13])?'background-image:url('.$um['baseSRC'].$um['items'][13].');':'background-image:none;background-color:'.$um['items'][13].';').$um['t'][5].$um['items'][1].'px;color:'.$um['items'][21].';font-style:'.$um['items'][24].';'.$um['t'][7].$um['items'][8].';'.$um['t'][6].$um['items'][7].';'.$um['items'][27].'}';
$umr[$j++]='.udm li a.udmR,.udm li a.udmY,.udm li'.$um['t'][35].',.udm li'.$um['t'][37].',.udm li a:hover,.udm li a:focus,.udm li'.$um['t'][27].',.udm li'.$um['t'][26].'{font-style:'.$um['items'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['items'][12])?'background-image:url('.$um['baseSRC'].$um['items'][12].');':'background-image:none;background-color:'.$um['items'][12].';').$um['t'][11].$um['items'][17].';color:'.$um['items'][20].';'.$um['t'][6].$um['items'][5].';'.$um['t'][7].$um['items'][6].';'.$um['t'][5].$um['items'][1].'px;'.$um['items'][26].'}';
$umr[$j++]='* html .udm li a:active{font-style:'.$um['items'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['items'][12])?'background-image:url('.$um['baseSRC'].$um['items'][12].');':'background-image:none;background-color:'.$um['items'][12].';').$um['t'][11].$um['items'][17].';color:'.$um['items'][20].';'.$um['t'][6].$um['items'][5].';'.$um['t'][7].$um['items'][6].';'.$um['t'][5].$um['items'][1].'px;'.$um['items'][26].'}';
$umr[$j++]='.udm ul a,.udm ul a:link,.udm ul a.nohref{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menuItems'][11])?'background-image:url('.$um['baseSRC'].$um['menuItems'][11].');':'background-image:none;background-color:'.$um['menuItems'][11].';').'text-align:'.$um['menuItems'][18].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][7].$um['menuItems'][4].';'.$um['t'][6].$um['menuItems'][3].';'.$um['t'][4].$um['menuItems'][9].'px;padding-right:'.$um['menuItems'][9].'px;'.$um['t'][1].$um['menuItems'][10].'px !important;padding-bottom:'.$um['menuItems'][10].'px !important;'.$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][19].';font-style:'.$um['menuItems'][22].';font-size:'.$um['menuItems'][14].';font-family:'.$um['menuItems'][15].';font-weight:'.$um['menuItems'][16].' !important;}';
...
$umr[$j++]='.udm ul li a:visited,'.$um['t'][20].'li a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menuItems'][13])?'background-image:url('.$um['baseSRC'].$um['menuItems'][13].');':'background-image:none;background-color:'.$um['menuItems'][13].';').'color:'.$um['menuItems'][21].';font-style:'.$um['menuItems'][24].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][7].$um['menuItems'][8].';'.$um['t'][6].$um['menuItems'][7].';'.$um['menuItems'][27].'}';
$umr[$j++]='.udm ul li a.udmR,.udm ul li a.udmY,.udm ul li'.$um['t'][35].',.udm ul li'.$um['t'][37].',.udm ul li a:hover,.udm ul li a:focus,.udm ul li'.$um['t'][27].',.udm ul li'.$um['t'][26].',.udm ul li'.$um['t'][25].'{font-style:'.$um['menuItems'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menuItems'][12])?'background-image:url('.$um['baseSRC'].$um['menuItems'][12].');':'background-image:none;background-color:'.$um['menuItems'][12].';').$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][20].';'.$um['t'][6].$um['menuItems'][5].';'.$um['t'][7].$um['menuItems'][6].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['menuItems'][26].'}';
$umr[$j++]='* html .udm ul li a:active{font-style:'.$um['menuItems'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$um['menuItems'][12])?'background-image:url('.$um['baseSRC'].$um['menuItems'][12].');':'background-image:none;background-color:'.$um['menuItems'][12].';').$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][20].';'.$um['t'][6].$um['menuItems'][5].';'.$um['t'][7].$um['menuItems'][6].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['menuItems'][26].'}';
...
{
$umr[$j++]='.udm ul.'.$umk.'{width:'.$umv[2].';'.$um['t'][6].$umv[0].';'.$um['t'][7].$umv[1].';'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[3])?'background-image:url('.$um['baseSRC'].$umv[3].');':'background-image:none;background-color:'.$umv[3].';').$umv[4].'}';
...
if($umv[5]!='none'){$umr[$j++]='.udm span.'.$umk.'{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[5])?'background-image:url('.$um['baseSRC'].$umv[5].');':'background-image:none;background-color:'.$umv[5].';').'filter:none;'.$umv[7].'}';}
}
}
...
{
$umbg=(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[6])?'background-image:url('.$um['baseSRC'].$umv[6].');':'background-image:none;background-color:'.$umv[6].';');
...
$umr[$j++]='.udm ul li.'.$umk.' a:visited,'.$um['t'][20].'li.'.$umk.' a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[8])?'background-image:url('.$um['baseSRC'].$umv[8].');':'background-image:none;background-color:'.$umv[8].';').'color:'.$umv[16].';font-style:'.$umv[19].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[4].';'.$um['t'][7].$umv[5].';'.$umv[22].'}';
$umr[$j++]='.udm ul li.'.$umk.' a.udmR,.udm ul li.'.$umk.' a.udmY,.udm ul li.'.$umk.$um['t'][35].',.udm ul li.'.$umk.$um['t'][37].',.udm ul li.'.$umk.' a:hover,.udm ul li.'.$umk.' a:focus,.udm ul li.'.$umk.$um['t'][27].',.udm ul li.'.$umk.$um['t'][26].',.udm ul li.'.$umk.$um['t'][25].'{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[7])?'background-image:url('.$um['baseSRC'].$umv[7].');':'background-image:none;background-color:'.$umv[7].';').$um['t'][11].$umv[12].';color:'.$umv[15].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[2].';'.$um['t'][7].$umv[3].';font-style:'.$umv[18].';'.$umv[21].'}';
$umr[$j++]='* html .udm li.'.$umk.' a:active{'.(eregi('(gif|png|mng|jpg|jpeg|bmp)',$umv[7])?'background-image:url('.$um['baseSRC'].$umv[7].');':'background-image:none;background-color:'.$umv[7].';').$um['t'][11].$umv[12].';color:'.$umv[15].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[2].';'.$um['t'][7].$umv[3].';font-style:'.$umv[18].';'.$umv[21].'}';
}
}
