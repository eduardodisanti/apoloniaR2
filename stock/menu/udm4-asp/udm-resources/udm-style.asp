...
um.r[j++]='.udm{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.hstrip[0])?'background-image:url('+um.baseSRC+um.hstrip[0]+');':'background-image:none;background-color:'+um.hstrip[0]+';')+'float:'+um.hfl+';width:100%;}';
if(um.hstrip[0]!='none')
{
...
um.r[j++]=um.t[2]+um.t[31]+'{margin-'+um.orientation[2]+':0;'+um.orientation[2]+':'+um.orientation[5]+';}}';
}
else
{
...
um.r[j++]=um.t[2]+um.t[31]+'>li:first-child{'+um.t[0]+um.orientation[4]+';}}';
...
um.r[j++]=um.t[18]+'ul[class^="udm"] li{left:'+um.orientation[4]+';'+um.t[19]+'}}';
...
if(um.dra){um.r[j++]=um.t[2]+um.t[34]+'{'+um.t[16]+'}}';}
...
um.r[j++]=um.t[2]+um.t[31]+' li:first-child{'+um.t[0]+um.orientation[4]+' !important;}}';
um.r[j++]=um.t[2]+um.t[31]+' li:first-child a{'+um.t[0]+'-'+um.items[1]+'px;}}';
um.r[j++]=um.t[2]+um.t[31]+' ul li:first-child{'+um.t[0]+'0 !important;}}';
um.r[j++]='head:first-child+body ul[class^="udm"] li:not(:first-child){'+um.t[0]+'-'+um.items[1]+'px;}';
...
if(um.dra)
{
um.r[j++]='* html .udm li{'+um.t[10]+'0;'+um.t[0]+um.items[0]+'px;}';
}
...
um.r[j++]='ul[class^="udm"] li{'+um.t[13]+um.items[0]+'px;}';
...
um.r[j++]='.udm ul{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menus[7])?'background-image:url('+um.baseSRC+um.menus[7]+');':'background-image:none;background-color:'+um.menus[7]+';')+um.t[15]+'width:'+um.menus[5]+';height:auto;'+um.t[5]+um.menus[2]+'px;'+um.t[6]+um.menus[3]+';'+um.t[7]+um.menus[4]+';'+um.t[12]+'z-index:'+(parseInt(um.orientation[6],10)+19100)+';padding:'+um.menus[6]+'px;'+um.menus[8]+'}';
...
um.r[j++]='ul.udm/**/[class^="udm"] u\\l{'+um.t[39]+um.t[41]+'left:-10000px;}';
...
if(um.menus[9]!='none')
{
um.r[j++]='.udm .udmS{'+um.t[0]+um.menus[10]+';margin-top:'+(um.menus[10]==0?0:um.menus[10].replace('-',''))+';}';
um.r[j++]='.udm .udmS{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menus[9])?'background-image:url('+um.baseSRC+um.menus[9]+');':'background-image:none;background-color:'+um.menus[9]+';')+um.t[15]+um.t[12]+'z-index:'+(parseInt(um.orientation[6],10)+19050)+';'+um.t[28]+'left:0px;top:0px;'+um.t[9]+um.menus[11]+'}';
...
um.r[j++]='.udm a,.udm a:link,.udm a.nohref{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.items[11])?'background-image:url('+um.baseSRC+um.items[11]+');':'background-image:none;background-color:'+um.items[11]+';')+um.t[29]+'z-index:'+parseInt(um.orientation[6],10)+';text-align:'+um.txl+';'+um.t[7]+um.items[4]+';'+um.t[6]+um.items[3]+';'+um.t[4]+um.items[9]+'px;padding-right:'+um.items[9]+'px;'+um.t[1]+um.items[10]+'px !important;padding-bottom:'+um.items[10]+'px !important;'+um.t[11]+um.items[17]+';color:'+um.items[19]+';'+um.t[5]+um.items[1]+'px;font-style:'+um.items[22]+';font-family:'+um.items[15]+';font-weight:'+um.items[16]+' !important;}';
...
um.r[j++]='.udm li a:visited{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.items[13])?'background-image:url('+um.baseSRC+um.items[13]+');':'background-image:none;background-color:'+um.items[13]+';')+um.t[5]+um.items[1]+'px;color:'+um.items[21]+';font-style:'+um.items[24]+';'+um.t[7]+um.items[8]+';'+um.t[6]+um.items[7]+';'+um.items[27]+'}';
um.r[j++]='.udm li a.udmR,.udm li a.udmY,.udm li'+um.t[35]+',.udm li'+um.t[37]+',.udm li a:hover,.udm li a:focus,.udm li'+um.t[27]+',.udm li'+um.t[26]+'{font-style:'+um.items[23]+';'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.items[12])?'background-image:url('+um.baseSRC+um.items[12]+');':'background-image:none;background-color:'+um.items[12]+';')+um.t[11]+um.items[17]+';color:'+um.items[20]+';'+um.t[6]+um.items[5]+';'+um.t[7]+um.items[6]+';'+um.t[5]+um.items[1]+'px;'+um.items[26]+'}';
um.r[j++]='* html .udm li a:active{font-style:'+um.items[23]+';'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.items[12])?'background-image:url('+um.baseSRC+um.items[12]+');':'background-image:none;background-color:'+um.items[12]+';')+um.t[11]+um.items[17]+';color:'+um.items[20]+';'+um.t[6]+um.items[5]+';'+um.t[7]+um.items[6]+';'+um.t[5]+um.items[1]+'px;'+um.items[26]+'}';
um.r[j++]='.udm ul a,.udm ul a:link,.udm ul a.nohref{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuItems[11])?'background-image:url('+um.baseSRC+um.menuItems[11]+');':'background-image:none;background-color:'+um.menuItems[11]+';')+'text-align:'+um.menuItems[18]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.t[7]+um.menuItems[4]+';'+um.t[6]+um.menuItems[3]+';'+um.t[4]+um.menuItems[9]+'px;padding-right:'+um.menuItems[9]+'px;'+um.t[1]+um.menuItems[10]+'px !important;padding-bottom:'+um.menuItems[10]+'px !important;'+um.t[11]+um.menuItems[17]+';color:'+um.menuItems[19]+';font-style:'+um.menuItems[22]+';font-size:'+um.menuItems[14]+';font-family:'+um.menuItems[15]+';font-weight:'+um.menuItems[16]+' !important;}';
...
um.r[j++]='.udm ul li a:visited,'+um.t[20]+'li a:visited{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuItems[13])?'background-image:url('+um.baseSRC+um.menuItems[13]+');':'background-image:none;background-color:'+um.menuItems[13]+';')+'color:'+um.menuItems[21]+';font-style:'+um.menuItems[24]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.t[7]+um.menuItems[8]+';'+um.t[6]+um.menuItems[7]+';'+um.menuItems[27]+'}';
um.r[j++]='.udm ul li a.udmR,.udm ul li a.udmY,.udm ul li'+um.t[35]+',.udm ul li'+um.t[37]+',.udm ul li a:hover,.udm ul li a:focus,.udm ul li'+um.t[27]+',.udm ul li'+um.t[26]+',.udm ul li'+um.t[25]+'{font-style:'+um.menuItems[23]+';'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuItems[12])?'background-image:url('+um.baseSRC+um.menuItems[12]+');':'background-image:none;background-color:'+um.menuItems[12]+';')+um.t[11]+um.menuItems[17]+';color:'+um.menuItems[20]+';'+um.t[6]+um.menuItems[5]+';'+um.t[7]+um.menuItems[6]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.menuItems[26]+'}';
um.r[j++]='* html .udm ul li a:active{font-style:'+um.menuItems[23]+';'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuItems[12])?'background-image:url('+um.baseSRC+um.menuItems[12]+');':'background-image:none;background-color:'+um.menuItems[12]+';')+um.t[11]+um.menuItems[17]+';color:'+um.menuItems[20]+';'+um.t[6]+um.menuItems[5]+';'+um.t[7]+um.menuItems[6]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.menuItems[26]+'}';
...
{
um.r[j++]='.udm ul.'+i+'{width:'+um.menuClasses[i][2]+';'+um.t[6]+um.menuClasses[i][0]+';'+um.t[7]+um.menuClasses[i][1]+';'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuClasses[i][3])?'background-image:url('+um.baseSRC+um.menuClasses[i][3]+');':'background-image:none;background-color:'+um.menuClasses[i][3]+';')+um.menuClasses[i][4]+'}';
um.r[j++]='.udm span.'+i+'{'+um.t[0]+um.menuClasses[i][6]+';margin-top:'+um.menuClasses[i][6].replace('-','')+';}';
if(/filter\:progid\:DXImageTransform\.Microsoft\.Shadow/.test(um.menuClasses[i][7]))
{
um.r[j++]=um.t[2]+'* html .udm span.'+i+'/**/ {'+um.t[8]+um.t[3]+'}}';
}
if(um.menuClasses[i][5]!='none'){um.r[j++]='.udm span.'+i+'{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.menuClasses[i][5])?'background-image:url('+um.baseSRC+um.menuClasses[i][5]+');':'background-image:none;background-color:'+um.menuClasses[i][5]+';')+'filter:none;'+um.menuClasses[i][7]+'}';}
}
}
if(um.itemClasses)
{
...
{
um.bg=(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.itemClasses[i][6])?'background-image:url('+um.baseSRC+um.itemClasses[i][6]+');':'background-image:none;background-color:'+um.itemClasses[i][6]+';');
...
um.r[j++]='.udm ul li.'+i+' a:visited,'+um.t[20]+'li.'+i+' a:visited{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.itemClasses[i][8])?'background-image:url('+um.baseSRC+um.itemClasses[i][8]+');':'background-image:none;background-color:'+um.itemClasses[i][8]+';')+'color:'+um.itemClasses[i][16]+';font-style:'+um.itemClasses[i][19]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.t[6]+um.itemClasses[i][4]+';'+um.t[7]+um.itemClasses[i][5]+';'+um.itemClasses[i][22]+'}';
um.r[j++]='.udm ul li.'+i+' a.udmR,.udm ul li.'+i+' a.udmY,.udm ul li.'+i+um.t[35]+',.udm ul li.'+i+um.t[37]+',.udm ul li.'+i+' a:hover,.udm ul li.'+i+' a:focus,.udm ul li.'+i+um.t[27]+',.udm ul li.'+i+um.t[26]+',.udm ul li.'+i+um.t[25]+'{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.itemClasses[i][7])?'background-image:url('+um.baseSRC+um.itemClasses[i][7]+');':'background-image:none;background-color:'+um.itemClasses[i][7]+';')+um.t[11]+um.itemClasses[i][12]+';color:'+um.itemClasses[i][15]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.t[6]+um.itemClasses[i][2]+';'+um.t[7]+um.itemClasses[i][3]+';font-style:'+um.itemClasses[i][18]+';'+um.itemClasses[i][21]+'}';
um.r[j++]='* html .udm li.'+i+' a:active{'+(/(gif|png|mng|jpg|jpeg|bmp)/i.test(um.itemClasses[i][7])?'background-image:url('+um.baseSRC+um.itemClasses[i][7]+');':'background-image:none;background-color:'+um.itemClasses[i][7]+';')+um.t[11]+um.itemClasses[i][12]+';color:'+um.itemClasses[i][15]+';'+um.t[5]+parseInt(um.menuItems[1],10)+'px;'+um.t[6]+um.itemClasses[i][2]+';'+um.t[7]+um.itemClasses[i][3]+';font-style:'+um.itemClasses[i][18]+';'+um.itemClasses[i][21]+'}';
}
}
