...
cabezal_proveedor($desde);
$ant = $desde;

$query="select id, nombre, unidadCompra, precio, proveedor from articulos, artprov where nombre > ' ' and id = artprov.articulo and proveedor >= $desde and proveedor <= $hasta and precio != 0 $filtro order by proveedor, nombre";
