...
$link=conectar();
echo "<head><title>Ingreso de orden de compras por proveedor</title>";
...
function recargar()
{
    ...
    window.location='ordencompra.php?prov='+xid;
}
";
...
echo "&nbsp;&nbsp;";
echo "<a href='imprimiroc.php?desde=$prov&hasta=$prov' target='_new'>Imprimir esta lista</a>";
echo "   </td>";
echo "</tr>";
