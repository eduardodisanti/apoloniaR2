...
$link=conectar();
echo "<head><title>Ingreso manual de lotes</title>";
echo "<script>";
echo "
function actualizar()
{
  var xid;
    ...
    f.src = 'elloteman.php?id='+id+'&cmd=actualizar';
}
...
function agregar()
{
  ...
  f.src = 'elloteman.php?articulo='+xid+'&cantidad='+xcant+'&lote='+lote+'&vence='+vence+'&cmd=add';
}
...
echo "<iframe src='elloteman.php?id=$almacen' width=850px height=250 id=frm>";
echo "</iframe>";
