...
$query = "select almacen, articulo, cantidad, nombre, unidadExpedicion, lote, tmpingman.vence from tmpingman, articulos where almacen= $id and articulos.id = articulo order by nombre";
