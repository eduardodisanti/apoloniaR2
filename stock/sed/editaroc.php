...
if($_SESSION['coinivelusuario'] < 3)
  die("Session no autorizada (".$_SESSION['coinivelusuario'].")");
...
$link=conectar();
echo "<head><title>Editar orden de compra</title>";
...
function cambiarProveedor() 
{
  var xid;
   ...
   xid = document.getElementById &&
         ...
         window.location='editaroc.php?prov='+xid;
}
...
echo "&nbsp;&nbsp;";
echo "<a href='imprimirocprov.php?desde=$prov&hasta=$prov'>Emitir esta orden</a>";
echo "   </td>";
echo "</tr>";
...
echo "<iframe id='frm' src='ocxprov.php?prov=$prov' width=99% height=295px border=0></iframe>";
